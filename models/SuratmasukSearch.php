...
class SuratmasukSearch extends Suratmasuk
{
    public function rules()
    {
        return [
            ...
            [['pengirim_suratmasuk', 'perihal_suratmasuk', 'tanggal_diterima', 'nomor_suratmasuk', 'tanggal_suratmasuk', 'timestamp', 'timestamp_lastupdate', 'reporter'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->joinWith(['reportere']);
        $query->where(['suratmasuk.deleted' => 0]);

        // if (Yii::$app->user->identity->approver_mobildinas === 0 && !Yii::$app->user->identity->issekretaris && Yii::$app->user->identity->level !== 0)
        //     $query->andWhere(['suratmasuk.sifat' => 0]);
