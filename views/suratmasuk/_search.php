...
<div class="card <?= ((!Yii::$app->user->isGuest && Yii::$app->user->identity->theme == 0) ? '' : 'bg-dark') ?>">
    <div class="card-body" style="margin: 0 auto!important">
        ...
        ?>
        <?= $form->field($model, 'pengirim_suratmasuk', ['autoPlaceholder' => false,])->textInput(['placeholder' => 'Dari ...']) ?>

        <?= $form->field($model, 'perihal_suratmasuk', ['autoPlaceholder' => false,])->textInput(['placeholder' => 'Perihal ...']) ?>
        ...
        <?= $form->field($model, 'nomor_suratmasuk', ['autoPlaceholder' => false,])->textInput(['placeholder' => 'Nomor ...']) ?>
