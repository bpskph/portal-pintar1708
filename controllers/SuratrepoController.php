...
class SuratrepoController extends BaseController
{
            ...
            [
                ...
                'access' => [
                    ...
                    'rules' => [
                        ...
                        [
                            'actions' => [
                                'index', 'create', 'update', 'delete', 'getnomorsurat', 'cetaksurat', 'view', 'list',
                                'gettemplate', 'lihatscan', 'uploadscan', 'uploadword', 'gettemplatelampiran', 'cetaklampiran'
    ...
    /**
     * Updates an existing Suratrepo model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param int $id_suratrepo Id Suratrepo
